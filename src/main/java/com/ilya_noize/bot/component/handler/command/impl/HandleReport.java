...
@Component
public class HandleReport implements HandleCommand {
    private static final Logger log = LoggerFactory.getLogger(HandleReport.class);

    public String getOperationType() {
        return Command.REPORT.getName();
    }
